...
SIMILAR_ACCOUNT = "swimming_motivation_daily" # Change this to an account of your choice
...
class InstaFollower:
    ...
    def find_followers(self):
        ...
        modal_xpath = "/html/body/div[6]/div[1]/div/div[2]/div/div/div/div/div[2]/div/div/div[3]/div[2]"

        # modal = self.driver.find_element(By.CLASS_NAME, '_aano')
        modal = self.driver.find_element(By.CSS_SELECTOR, "div._aano")
        # modal = self.driver.find_element(by=By.XPATH, value="//div[@class='_aano']")

        for i in range(5):
            # In this case I am executing some Javascript, that's what the execute_script() method does.
